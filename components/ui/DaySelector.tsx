...
type DaySelectorProps = {
  ...
  neomorphic?: boolean; // Enable neomorphic styling
};
  ...
  if (fullWidthLayout && onGoToToday) {
    return (
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-center gap-2">
          {showNavigation && (
            <button
              ...
              className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 ${
                neomorphic
                  ? "bg-neutral-200 dark:bg-neutral-700 shadow-[3px_3px_6px_rgba(0,0,0,0.1),-3px_-3px_6px_rgba(255,255,255,0.7)] dark:shadow-[3px_3px_6px_rgba(0,0,0,0.4),-3px_-3px_6px_rgba(255,255,255,0.05)] active:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.15)] border-none"
          ...
          <div className="flex-1 relative">
            <button
              ...
              className={`w-full px-4 py-2 rounded-full text-center font-medium flex items-center justify-center gap-2 transition-all duration-200 ${
                neomorphic
                  ? "bg-neutral-200 dark:bg-neutral-700 shadow-[4px_4px_8px_rgba(0,0,0,0.1),-4px_-4px_8px_rgba(255,255,255,0.7)] dark:shadow-[4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)] active:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.1),inset_-2px_-2px_4px_rgba(255,255,255,0.5)] border-none"
                  : "border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800"
              }`}
            >
              <svg
        ...
        <button
          onClick={onGoToToday}
          className={`w-full px-4 py-3 rounded-full text-base font-medium transition-all duration-200 ${
            isToday
              ? `text-white border-transparent`
              : neomorphic
              ? "bg-neutral-200 dark:bg-neutral-700 shadow-[4px_4px_8px_rgba(0,0,0,0.1),-4px_-4px_8px_rgba(255,255,255,0.7)] dark:shadow-[4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)] active:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.1),inset_-2px_-2px_4px_rgba(255,255,255,0.5)] border-none"
    ...
    <div className={hasSettingsButton ? "pr-14" : ""}>
      ...
      {onGoToToday && (
        <div className="mt-2">
          <button
            onClick={onGoToToday}
            className={`w-full px-3 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
              isToday
                ? `text-white border-transparent`
                : neomorphic
                ? "bg-neutral-200 dark:bg-neutral-700 shadow-[4px_4px_8px_rgba(0,0,0,0.1),-4px_-4px_8px_rgba(255,255,255,0.7)] dark:shadow-[4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)] active:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.1),inset_-2px_-2px_4px_rgba(255,255,255,0.5)] border-none"
