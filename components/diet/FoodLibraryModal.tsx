          ...
          {results.map((f, i) => {
            ...
            return (
              <li key={`${f.description}-${i}`}>
                <div
                  ref={setRowRef(i)}
                  className="relative rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/60 backdrop-blur p-3 shadow-sm"
                >
                  <button
                        ...
                        {mode === "servings" && (
                          <div className="space-y-2">
                            <label className="block text-sm">
                              Portion
                              <select
                                className="mt-1 w-full rounded-lg border px-2 py-2 bg-white dark:bg-neutral-900"
                                value={selPortionIdx}
                            ...
                            <label className="block text-sm">
                              ...
                              <div className="mt-1 flex items-center gap-2">
                                ...
                                <input
                                  inputMode="decimal"
                                  className="w-16 text-center h-10 rounded-lg border border-neutral-300 dark:border-neutral-700 px-2 bg-white dark:bg-neutral-900"
                                  value={servings}
                                  onChange={(e) =>
                          ...
                          return (
                            <>
                              ...
                              <div className="mt-3 flex justify-end gap-2">
                                ...
                                <button
                                  className="px-3 py-2 rounded-lg bg-[#34D399] text-black"
                                  onClick={() => {
                                    onPick({
