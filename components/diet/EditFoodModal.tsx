  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[100010] flex items-center justify-center p-4">
        <div className="w-full max-w-xl max-h-[80vh] overflow-y-auto rounded-3xl bg-neutral-100 dark:bg-neutral-800 shadow-[12px_12px_24px_rgba(0,0,0,0.15),-12px_-12px_24px_rgba(255,255,255,0.7)] dark:shadow-[12px_12px_24px_rgba(0,0,0,0.6),-12px_-12px_24px_rgba(255,255,255,0.05)] p-4">
          ...
          <>
            {/* Segmented control */}
            <div className="grid grid-cols-2 gap-2 text-sm mb-3 bg-neutral-200 dark:bg-neutral-700 shadow-[inset_4px_4px_8px_rgba(0,0,0,0.1),inset_-4px_-4px_8px_rgba(255,255,255,0.7)] dark:shadow-[inset_4px_4px_8px_rgba(0,0,0,0.3),inset_-4px_-4px_8px_rgba(255,255,255,0.03)] rounded-full p-1">
                {(["servings", "weight"] as const).map((m) => (
                  <button
                    ...
                    className={
                      ...
                      (mode === m
                        ? "bg-neutral-100 dark:bg-neutral-800 shadow-[3px_3px_6px_rgba(0,0,0,0.1),-3px_-3px_6px_rgba(255,255,255,0.7)] dark:shadow-[3px_3px_6px_rgba(0,0,0,0.4),-3px_-3px_6px_rgba(255,255,255,0.05)] text-accent-diet"
              ...
              {mode === "servings" && (
                <div className="space-y-2">
                  <label className="block text-sm">
                    Portion
                    <select
                      className="mt-1 w-full rounded-full bg-neutral-100 dark:bg-neutral-800 shadow-[inset_4px_4px_8px_rgba(0,0,0,0.1),inset_-4px_-4px_8px_rgba(255,255,255,0.6)] dark:shadow-[inset_4px_4px_8px_rgba(0,0,0,0.3),inset_-4px_-4px_8px_rgba(255,255,255,0.03)] px-2 py-2 border-none focus:outline-none focus:ring-2 focus:ring-accent-diet/30 transition-all duration-200"
                      value={selPortionIdx}
                  ...
                  <label className="block text-sm">
                    ...
                    <div className="mt-1 flex items-center gap-2">
                      <button
                        type="button"
                        className="w-10 h-10 rounded-full bg-neutral-200 dark:bg-neutral-700 shadow-[3px_3px_6px_rgba(0,0,0,0.1),-3px_-3px_6px_rgba(255,255,255,0.7)] dark:shadow-[3px_3px_6px_rgba(0,0,0,0.4),-3px_-3px_6px_rgba(255,255,255,0.05)] grid place-items-center text-xl transition-all duration-200 active:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.15)]"
                        onClick={() =>
                          setServings((s) => {
                            const v = safeNum(s) - 1;
                      ...
                      <input
                        inputMode="decimal"
                        className="w-16 text-center h-10 rounded-full bg-neutral-100 dark:bg-neutral-800 shadow-[inset_4px_4px_8px_rgba(0,0,0,0.1),inset_-4px_-4px_8px_rgba(255,255,255,0.6)] dark:shadow-[inset_4px_4px_8px_rgba(0,0,0,0.3),inset_-4px_-4px_8px_rgba(255,255,255,0.03)] px-2 border-none focus:outline-none focus:ring-2 focus:ring-accent-diet/30 transition-all duration-200"
                        value={servings}
                        onChange={(e) =>
                ...
                <div className="space-y-2">
                  <label className="block text-sm">
                    ...
                    <div className="mt-1 flex items-center gap-2">
                      ...
                      <input
                        inputMode="decimal"
                        className="w-20 text-center h-10 rounded-full bg-neutral-100 dark:bg-neutral-800 shadow-[inset_4px_4px_8px_rgba(0,0,0,0.1),inset_-4px_-4px_8px_rgba(255,255,255,0.6)] dark:shadow-[inset_4px_4px_8px_rgba(0,0,0,0.3),inset_-4px_-4px_8px_rgba(255,255,255,0.03)] px-2 border-none focus:outline-none focus:ring-2 focus:ring-accent-diet/30 transition-all duration-200"
                        value={grams}
                        onChange={(e) =>
          ...
          <div className="mt-3">
            ...
            <div className="mt-1 flex items-center gap-2 flex-nowrap overflow-x-auto tabular-nums">
              <span
                className="inline-flex items-center rounded-full px-3 py-1 text-sm font-semibold whitespace-nowrap bg-neutral-200 dark:bg-neutral-700 shadow-[2px_2px_4px_rgba(0,0,0,0.1),-2px_-2px_4px_rgba(255,255,255,0.7)] dark:shadow-[2px_2px_4px_rgba(0,0,0,0.4),-2px_-2px_4px_rgba(255,255,255,0.05)]"
                style={{ color: "#34D399" }}
              >
                <span
                  className="inline-flex items-center justify-center w-5 h-5 rounded-full mr-1 leading-none text-center text-[9px] shadow-[1px_1px_2px_rgba(0,0,0,0.1),-1px_-1px_2px_rgba(255,255,255,0.7)] dark:shadow-[1px_1px_2px_rgba(0,0,0,0.4),-1px_-1px_2px_rgba(255,255,255,0.05)]"
              ...
              <span
                className="inline-flex items-center rounded-full px-1.5 py-0.5 text-sm font-semibold whitespace-nowrap bg-neutral-200 dark:bg-neutral-700 shadow-[2px_2px_4px_rgba(0,0,0,0.1),-2px_-2px_4px_rgba(255,255,255,0.7)] dark:shadow-[2px_2px_4px_rgba(0,0,0,0.4),-2px_-2px_4px_rgba(255,255,255,0.05)]"
                style={{ color: "#F87171" }}
              >
                <span
                  className="inline-flex items-center justify-center w-4 h-4 rounded-full mr-1 leading-none text-center text-[9px] shadow-[1px_1px_2px_rgba(0,0,0,0.1),-1px_-1px_2px_rgba(255,255,255,0.7)] dark:shadow-[1px_1px_2px_rgba(0,0,0,0.4),-1px_-1px_2px_rgba(255,255,255,0.05)]"
          ...
          <div className="mt-3 flex justify-between gap-2">
            ...
            <div className="flex gap-2 ml-auto">
              ...
              <button
                className="px-3 py-2 rounded-full bg-neutral-200 dark:bg-neutral-700 shadow-[4px_4px_8px_rgba(0,0,0,0.1),-4px_-4px_8px_rgba(255,255,255,0.7)] dark:shadow-[4px_4px_8px_rgba(0,0,0,0.4),-4px_-4px_8px_rgba(255,255,255,0.05)] text-accent-diet font-semibold transition-all duration-200 active:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.1),inset_-2px_-2px_4px_rgba(255,255,255,0.5)]"
                onClick={handleSave}
              >
                Save
              </button>
