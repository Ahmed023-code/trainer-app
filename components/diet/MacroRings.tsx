...
export default function MacroRings({
  ...
  return (
    <div className="rounded-3xl p-3 sm:p-4 bg-neutral-100 dark:bg-neutral-800 shadow-[8px_8px_16px_rgba(0,0,0,0.1),-8px_-8px_16px_rgba(255,255,255,0.7)] dark:shadow-[8px_8px_16px_rgba(0,0,0,0.5),-8px_-8px_16px_rgba(255,255,255,0.05)] w-full">
    ...
    <div className="flex flex-col items-center justify-center flex-1 min-w-0 shrink">
      <div className="relative" style={{ width: size, height: size }}>
        ...
        <div className="absolute inset-0 grid place-items-center">
          <span
            className="inline-grid place-items-center rounded-full font-extrabold text-[10px] leading-none shadow-[2px_2px_4px_rgba(0,0,0,0.1),-2px_-2px_4px_rgba(255,255,255,0.7)] dark:shadow-[2px_2px_4px_rgba(0,0,0,0.4),-2px_-2px_4px_rgba(255,255,255,0.05)]"
      ...
      <div className="mt-1.5 flex flex-col items-center gap-1">
        ...
        {diff !== 0 && (
          <span
            className="inline-flex items-center rounded-full px-2 py-0.5 text-[10px] sm:text-[11px] font-extrabold gap-0.5 shadow-[2px_2px_4px_rgba(0,0,0,0.1),-2px_-2px_4px_rgba(255,255,255,0.7)] dark:shadow-[2px_2px_4px_rgba(0,0,0,0.4),-2px_-2px_4px_rgba(255,255,255,0.05)]"
            style={{
