          ...
          {savedWeight === null || parseFloat(weightValue) !== savedWeight ? (
            ...
            <div className="flex items-center justify-center gap-3">
              <button
                ...
                className="w-10 h-10 rounded-full border-2 border-accent-progress text-accent-progress flex items-center justify-center hover:bg-accent-progress/10 transition-colors font-bold text-xl"
              >
                −
              </button>
