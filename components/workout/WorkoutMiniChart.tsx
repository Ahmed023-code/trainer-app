...
export default function WorkoutMiniChart({
  ...
  if (data.length === 0) {
    return (
      <div
        className="flex items-center justify-center rounded-2xl bg-neutral-100 dark:bg-neutral-800 shadow-[6px_6px_12px_rgba(0,0,0,0.1),-6px_-6px_12px_rgba(255,255,255,0.7)] dark:shadow-[6px_6px_12px_rgba(0,0,0,0.5),-6px_-6px_12px_rgba(255,255,255,0.05)]"
  ...
  if (variant === "area") {
    ...
    return (
      <div className="relative w-full rounded-2xl bg-neutral-100 dark:bg-neutral-800 shadow-[6px_6px_12px_rgba(0,0,0,0.1),-6px_-6px_12px_rgba(255,255,255,0.7)] dark:shadow-[6px_6px_12px_rgba(0,0,0,0.5),-6px_-6px_12px_rgba(255,255,255,0.05)] px-3 py-2">
        <svg
        ...
        {tooltip && (
          <div
            className="absolute z-10 rounded-full bg-neutral-200 dark:bg-neutral-700 shadow-[4px_4px_8px_rgba(0,0,0,0.15),-4px_-4px_8px_rgba(255,255,255,0.7)] dark:shadow-[4px_4px_8px_rgba(0,0,0,0.5),-4px_-4px_8px_rgba(255,255,255,0.05)] px-3 py-2 pointer-events-none"
            style={{
              left: tooltip.x,
              top: tooltip.y - 50,
