        ...
        <div className="w-full flex items-start gap-3">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            {(exercise as any).gifUrl && (
              <div className="flex-shrink-0 w-[52px] h-[52px] rounded-full overflow-hidden bg-neutral-200 dark:bg-neutral-700 shadow-[3px_3px_6px_rgba(0,0,0,0.1),-3px_-3px_6px_rgba(255,255,255,0.7)] dark:shadow-[3px_3px_6px_rgba(0,0,0,0.4),-3px_-3px_6px_rgba(255,255,255,0.05)]">
                <ExerciseGif
          ...
          <div className="flex items-center gap-2 shrink-0 pt-0.5">
            ...
            {onAddSet && (
              <button
                ...
                className="tap-target w-9 h-9 flex items-center justify-center rounded-full bg-neutral-200 dark:bg-neutral-700 shadow-[3px_3px_6px_rgba(0,0,0,0.1),-3px_-3px_6px_rgba(255,255,255,0.7)] dark:shadow-[3px_3px_6px_rgba(0,0,0,0.4),-3px_-3px_6px_rgba(255,255,255,0.05)] text-[var(--accent-workout)] transition-all duration-200 active:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.15)]"
              ...
              <div className="space-y-3">
                {exercise.sets.map((s, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={`grid grid-cols-[minmax(24px,30px),minmax(80px,90px),minmax(50px,70px),minmax(50px,1fr),minmax(40px,50px),minmax(36px,50px)] gap-1 items-center rounded-xl px-1 py-1 bg-neutral-50 dark:bg-neutral-800/50 shadow-[inset_2px_2px_4px_rgba(0,0,0,0.08),inset_-2px_-2px_4px_rgba(255,255,255,0.6)] dark:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.2),inset_-2px_-2px_4px_rgba(255,255,255,0.02)]`}
                      onClick={(e) => e.stopPropagation()}
                    >
                      {/* Set number */}
                      ...
                      <select
                        ...
                        onClick={(e) => e.stopPropagation()}
                        className="text-xs font-medium px-2 py-2 rounded-full bg-neutral-200 dark:bg-neutral-700 shadow-[2px_2px_4px_rgba(0,0,0,0.1),-2px_-2px_4px_rgba(255,255,255,0.7)] dark:shadow-[2px_2px_4px_rgba(0,0,0,0.4),-2px_-2px_4px_rgba(255,255,255,0.05)] border-0 cursor-pointer focus:outline-none focus:ring-2 focus:ring-accent-workout/30 min-w-0 transition-all duration-200"
                      >
                      ...
                      <input
                        ...
                        onClick={(e) => e.stopPropagation()}
                        className="text-sm font-medium tabular-nums px-2 py-2 rounded-full bg-neutral-100 dark:bg-neutral-800 shadow-[inset_2px_2px_4px_rgba(0,0,0,0.1),inset_-2px_-2px_4px_rgba(255,255,255,0.6)] dark:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.3),inset_-2px_-2px_4px_rgba(255,255,255,0.03)] border-0 text-center focus:outline-none focus:ring-2 focus:ring-accent-workout/30 min-w-0 transition-all duration-200"
                      ...
                      <div className="relative flex items-center justify-center min-w-[50px]">
                        {isQuickAdd ? (
                          ...
                          <input
                            ...
                            onClick={(e) => e.stopPropagation()}
                            className="w-full text-sm font-medium tabular-nums px-2 py-2 rounded-full bg-neutral-100 dark:bg-neutral-800 shadow-[inset_2px_2px_4px_rgba(0,0,0,0.1),inset_-2px_-2px_4px_rgba(255,255,255,0.6)] dark:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.3),inset_-2px_-2px_4px_rgba(255,255,255,0.03)] border-0 text-center focus:outline-none focus:ring-2 focus:ring-accent-workout/30 transition-all duration-200"
                          ...
                          <>
                            ...
                            <input
                              ...
                              onClick={(e) => e.stopPropagation()}
                              className="relative w-full text-sm font-medium tabular-nums px-2 py-2 rounded-full bg-neutral-100 dark:bg-neutral-800 shadow-[inset_2px_2px_4px_rgba(0,0,0,0.1),inset_-2px_-2px_4px_rgba(255,255,255,0.6)] dark:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.3),inset_-2px_-2px_4px_rgba(255,255,255,0.03)] border-0 text-center focus:outline-none focus:ring-2 focus:ring-accent-workout/30 transition-all duration-200"
                      ...
                      <input
                        ...
                        onClick={(e) => e.stopPropagation()}
                        className="w-full text-sm font-medium tabular-nums px-1 py-2 rounded-full bg-neutral-100 dark:bg-neutral-800 shadow-[inset_2px_2px_4px_rgba(0,0,0,0.1),inset_-2px_-2px_4px_rgba(255,255,255,0.6)] dark:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.3),inset_-2px_-2px_4px_rgba(255,255,255,0.03)] border-0 text-center focus:outline-none focus:ring-2 focus:ring-accent-workout/30 transition-all duration-200"
                      ...
                      {onUpdateExercise && (
                        <div className="relative flex items-center justify-center">
                          <button
                            ...
                            className="shrink-0 w-7 h-7 flex items-center justify-center rounded-full bg-neutral-200 dark:bg-neutral-700 shadow-[2px_2px_4px_rgba(0,0,0,0.1),-2px_-2px_4px_rgba(255,255,255,0.7)] dark:shadow-[2px_2px_4px_rgba(0,0,0,0.4),-2px_-2px_4px_rgba(255,255,255,0.05)] transition-all duration-200 active:shadow-[inset_1px_1px_2px_rgba(0,0,0,0.15)]"
      ...
      {showConfirm &&
        ...
        createPortal(
          <>
            ...
            >
              <div
                className="bg-neutral-100 dark:bg-neutral-800 rounded-3xl shadow-[12px_12px_24px_rgba(0,0,0,0.15),-12px_-12px_24px_rgba(255,255,255,0.7)] dark:shadow-[12px_12px_24px_rgba(0,0,0,0.6),-12px_-12px_24px_rgba(255,255,255,0.05)] p-6 max-w-sm w-full"
                onClick={(e) => e.stopPropagation()}
              >
